...
|               | `chance-affine-uni` |                                            Guaranteed underapproximation  [^CDC2011_chance]                                            | Affine   disturbance-feedback (decoupled risk allocation and controller synthesis)              |
|               | `chance-affine` |                                            Guaranteed underapproximation  [^CDC2019_chance]                                            | Affine   disturbance-feedback (coupled risk allocation and controller synthesis)             |
...
[^CDC2011_chance]: M. Vitus and C. Tomlin, "[On feedback design and risk allocation in chance constrained control](https://doi-org/10.1109/CDC.2011.6160721)", in Proceedings of Conference on Decision and Control, 2011.
